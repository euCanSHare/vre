$(document).ready(function() {
	...
	var urlJSON_files = 'applib/getData.php?uploadType=repository&data_type=bioimage&file_type=ZIP&url='+encodeURI('https://xnat.bmia.nl/data/archive/projects/'+project_id+'/subjects/'+subject_id+'/experiments/'+id+'/scans/ALL/files?format=zip')
